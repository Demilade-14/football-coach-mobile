...
// Simple StarRating component with proper emoji fallback
  ...
  return (
    <View style={styles.starContainer}>
      {[...Array(max)].map((_, i) => (
        ...
        >
          <Text style={[styles.star, i < value ? styles.starActive : styles.starInactive]}>
            {i < value ? '?' : '?'}
          </Text>
        </TouchableOpacity>
      ))}
...
// In app/ProfileForm.js, update the useEffect around line 87:
...
useEffect(() => {
  ...
  return (
    ...
    >
      <Text style={styles.title}><MaterialIcons name="sports-soccer" size={24} color="#ffd700" /> Player Profile</Text>
      ...
      <View style={styles.imageSection}>
        <Text style={styles.label}><MaterialIcons name="photo-camera" size={18} color="#a8dadc" /> Add Your Face (Optional)</Text>
      ...
      <Text style={styles.label}><MaterialCommunityIcons name="flash" size={18} color="#a8dadc" /> Quick Templates</Text>
      ...
      <TouchableOpacity style={styles.input} onPress={() => setShowCountryPicker(true)}>
        <Text style={nationality ? styles.selectedCountry : styles.placeholderText}>
          {nationality || '<MaterialIcons name="public" size={18} color="#a8dadc" /> Select Nationality'}
        </Text>
      </TouchableOpacity>
      ...
      <Text style={styles.label}><MaterialCommunityIcons name="foot-print" size={18} color="#a8dadc" /> Preferred Foot</Text>
      ...
      <View style={styles.skillRow}>
        <View style={styles.skillItem}>
          <Text style={styles.label}><MaterialCommunityIcons name="flash" size={18} color="#a8dadc" /> Skill Moves</Text>
        ...
        <View style={styles.skillItem}>
          <Text style={styles.label}><MaterialCommunityIcons name="foot-print" size={18} color="#a8dadc" /> Weak Foot</Text>
      ...
      <View style={styles.conditionsSection}>
        <TouchableOpacity style={[styles.conditionButton, disability && styles.conditionActive]} onPress={() => setDisability(!disability)}>
          <Text style={[styles.conditionText, disability && styles.conditionTextActive]}><MaterialIcons name="accessible" size={18} color="#a8dadc" /> Disability Support</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.conditionButton, mentalStress && styles.conditionActive]} onPress={() => setMentalStress(!mentalStress)}>
          <Text style={[styles.conditionText, mentalStress && styles.conditionTextActive]}><MaterialIcons name="psychology" size={18} color="#a8dadc" /> Mental Health Support</Text>
        </TouchableOpacity>
      </View>

      <Text style={styles.sectionTitle}><MaterialIcons name="analytics" size={20} color="#ffd700" /> Player Attributes</Text>
      
      <Text style={styles.categoryTitle}><MaterialIcons name="directions-run" size={16} color="#34495e" /> Pace</Text>
      ...
      <Text style={styles.categoryTitle}><MaterialIcons name="sports" size={16} color="#34495e" /> Shooting</Text>
      ...
      <Text style={styles.categoryTitle}><MaterialIcons name="target" size={16} color="#34495e" /> Passing</Text>
      ...
      <Text style={styles.categoryTitle}><MaterialIcons name="sports-esports" size={16} color="#34495e" /> Dribbling</Text>
      ...
      <Text style={styles.categoryTitle}><MaterialIcons name="shield" size={16} color="#34495e" /> Defending</Text>
      ...
      <Text style={styles.categoryTitle}><MaterialIcons name="fitness-center" size={16} color="#34495e" /> Physical</Text>
      ...
      <Text style={styles.categoryTitle}><MaterialIcons name="sports" size={16} color="#34495e" /> Goalkeeping</Text>
      ...
      {cardData && (
        <View style={styles.previewSection}>
          <Text style={styles.sectionTitle}><MaterialIcons name="visibility" size={20} color="#ffd700" /> Live Preview</Text>
          <PlayerCard data={cardData} />
        </View>
      )}

      <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
        <Text style={styles.submitText}><MaterialIcons name="card-membership" size={20} color="#fff" /> Generate Player Card</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  suggestionText: { fontSize: isSmallScreen ? 9 : 10, color: '#3498db', marginBottom: 5, fontStyle: 'italic', textAlign: 'center' },
  starContainer: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginVertical: 5 },
  starButton: { padding: isSmallScreen ? 1 : 2 },
  star: { fontSize: isSmallScreen ? 16 : 20, marginHorizontal: 2 },
